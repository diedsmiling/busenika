{* $Id: products_scroller.tpl 9783 2010-06-10 10:24:09Z lexa $ *}
...
<div align="center">
	<ul id="scroll_list_{$block.block_id}" class="jcarousel-skin hidden">
		...
		{foreach from=$items item="product" name="for_products"}
			...
			{include file="common_templates/image.tpl" assign="object_img" image_width=$block.properties.thumbnail_width image_height=120 images=$product.main_pair no_ids=true object_type=$img_object_type show_thumbnail="Y"}
