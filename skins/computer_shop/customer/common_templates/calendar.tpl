{* $Id: calendar.tpl 9910 2010-06-30 08:22:42Z angel $ *}
...
<input type="text" id="{$date_id}" name="{$date_name}" class="input-text-medium cm-calendar-value{if $extra} disabled{/if}" value="{if $date_val}{$date_val|date_format:"`$date_format`"}{/if}" {$extra} size="10" />&nbsp;<img src="{$images_dir}/icons/calendar.gif" class="cm-combo-on cm-combination calendar-but hand" id="sw_{$date_id}_picker" title="{$lang.calendar}" alt="{$lang.calendar}" />
