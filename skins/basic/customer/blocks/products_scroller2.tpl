{* $Id: products_scroller2.tpl 9783 2010-06-10 10:24:09Z lexa $ *}
					...
					<td valign="middle" class="left">
						...
						<tr>
							...
							<td valign="top" class="product-item-image">
								<a href="{"products.view?product_id=`$product.product_id`"|fn_url}">{include file="common_templates/image.tpl" image_width=$block.properties.thumbnail_width images=$product.main_pair no_ids=true show_thumbnail="Y"}</a></td>
							<td>&nbsp;</td>
							{/if}
