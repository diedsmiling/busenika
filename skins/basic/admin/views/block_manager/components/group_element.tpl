{* $Id: group_element.tpl 8248 2009-11-17 11:36:32Z lexa $ *}
...
{if ($block_data.text_id == $blocks_target || $block_data.block_id == $blocks_target) && $block_data.block_type == "G"}
	...
	<div id="blocks_group_{$blocks_target}" class="cm-list-box cm-group-box block-container base-block">
		<div class="block-manager">
			...
			<div id="{$block_content_id}" class="cm-sortable-items group-content grab-items cm-disallowed-group{if !$smarty.cookies.$block_content_id} hidden{/if}">
	{/if}
