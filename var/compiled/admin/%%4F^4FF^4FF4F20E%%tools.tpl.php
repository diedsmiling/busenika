...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_check_view_permissions', 'common_templates/tools.tpl', 3, false),array('modifier', 'substr_count', 'common_templates/tools.tpl', 7, false),array('modifier', 'replace', 'common_templates/tools.tpl', 8, false),array('modifier', 'default', 'common_templates/tools.tpl', 13, false),array('modifier', 'defined', 'common_templates/tools.tpl', 21, false),array('modifier', 'fn_url', 'common_templates/tools.tpl', 23, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('or','tools','add'));
?>
<?php  ob_start();  ?>
...
<?php else: ?>select-link<?php endif; ?><?php if ($this->_tpl_vars['link_meta']): ?> <?php echo $this->_tpl_vars['link_meta']; ?>
