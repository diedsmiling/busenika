...
//
// $Id: exim.post.php 10229 2010-07-27 14:21:39Z 2tl $
//
...
if ($mode == 'export_datafeed') {
	...
	return array(CONTROLLER_STATUS_OK, empty($_SERVER['HTTP_REFERER']) ? "data_feeds.manage" . $_suffix : fn_query_remove($_SERVER['HTTP_REFERER'], 'meta_redirect_url') . $_suffix);
