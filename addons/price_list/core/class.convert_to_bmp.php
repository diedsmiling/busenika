...
//
// $Id: class.convert_to_bmp.php 9141 2010-03-23 13:22:48Z alexions $
//
...
class ConvertToBMP
{
	...
	public function convert($source = '')
	{
		...
		switch (exif_imagetype($this->source)) {
			case IMAGETYPE_GIF:
				$result = $this->_convert_image($this->source, 'gif');
				break;
			case IMAGETYPE_JPEG:
				$result = $this->_convert_image($this->source, 'jpg');
				break;
			case IMAGETYPE_PNG:
				$result = $this->_convert_image($this->source, 'png');
				break;
			case IMAGETYPE_BMP:
	...
	private function _convert_image($source, $type)
	{
		if ($type == 'jpg') {
