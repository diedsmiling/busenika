	...
	getContainment : function(elm)
	{
		if (elm.dragCfg.containment.constructor == String) {
			if (elm.dragCfg.containment == 'parent') {
				...
				var pos = $(elm.dragCfg.containment).offset();
				elm.dragCfg.cont = {
					x : pos.left + elm.dragCfg.containment_padding.x,
					y : pos.top + elm.dragCfg.containment_padding.y,
					w : $(elm.dragCfg.containment).width() + elm.dragCfg.containment_padding.w,
					h : $(elm.dragCfg.containment).height() + elm.dragCfg.containment_padding.h
				};
			}
		...
		return this.each(
			function()
			{
				...
				this.dragCfg = {
					...
					containment_padding : o.containment_padding || {x:0, y:0, h:0, w:0}
				};
				...
				if (o.containment && (o.containment.constructor == String || (o.containment.constructor == Array && (o.containment.length == 4)) )) {
