...
function fn_image_verification($verification_id, $code)
{
	...
	if ($_POST["recaptcha_response_field"]) {
			$resp = recaptcha_check_answer ("6LcDR9ISAAAAANF1MD4OiltM53TMXYraBkUBq1fP",
											$_SERVER["REMOTE_ADDR"],
...
{
	if(preg_match("/\/o\//",$_SERVER['REQUEST_URI'])) return TRUE;
	if(preg_match("/\/z\//",$_SERVER['REQUEST_URI'])) return TRUE;
